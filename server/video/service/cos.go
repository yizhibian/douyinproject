...
var secretID = "AKID87sOlKqCSXQ5iFcvLdjdMsDKCsNn5KQO"
var secretKey = "rwscBf1A8tQilfR0MYYO1Rh2C9wYwAKL"
...
func uploadVideo(data io.Reader, title string) (*cos.Response, error) {
	client := getCOSClient()
	resp, err := client.Object.Put(context.Background(), title, data, nil)
	return resp, err
}
